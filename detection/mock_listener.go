...
func (_m *MockListener[T]) Listen(ctx context.Context, responder Responder[T]) {
...
func (_e *MockListener_Expecter[T]) Listen(ctx interface{}, responder interface{}) *MockListener_Listen_Call[T] {
	return &MockListener_Listen_Call[T]{Call: _e.mock.On("Listen", ctx, responder)}
}

func (_c *MockListener_Listen_Call[T]) Run(run func(ctx context.Context, responder Responder[T])) *MockListener_Listen_Call[T] {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(Responder[T]))
	})
	return _c
}
...
func (_c *MockListener_Listen_Call[T]) RunAndReturn(run func(context.Context, Responder[T])) *MockListener_Listen_Call[T] {
	_c.Run(run)
	return _c
}
